...
import 'package:paquetes/models/currency.dart';
import 'package:paquetes/models/flags.dart';
import 'package:paquetes/models/language.dart';
import 'package:paquetes/models/regional_bloc.dart';
import 'package:paquetes/models/translations.dart';
...
class Pais {
    ...
    factory Pais.fromMap(Map<String, dynamic> json) => Pais(
        ...
        flag: json["flag"],
        regionalBlocs: json["regionalBlocs"] == null ? null : List<RegionalBloc>.from(json["regionalBlocs"].map((x) => RegionalBloc.fromMap(x))),
